...
DATABASES = {
    'default': {
        ...
        'NAME': '/data/askbot.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '4340445f5077f8bdab1afaa8e2820fb8'
...
#ASKBOT_EXTRA_SKINS_DIR = os.path.join(os.path.dirname(__file__),'themes') #path to your private skin collection
